...
function makeFetchBody(a) {
  ...
  a: {
    var c = a.query;
    for (var d = 0, e = c.definitions.length; d < e; d++) {
      var f = c.definitions[d];
      if (f.kind === Kind.OPERATION_DEFINITION && f.name) {
        c = f.name.value;
        break a;
      }
    }
...
function makeFetchURL(a, b) {
  ...
  c += "?query=" + encodeURIComponent(b.query);
  b.variables && (c += "&variables=" + encodeURIComponent(u(b.variables)));
  b.extensions && (c += "&extensions=" + encodeURIComponent(u(b.extensions)));
  return c;
}
...
//# sourceMappingURL=10c87a5f.mjs.map
