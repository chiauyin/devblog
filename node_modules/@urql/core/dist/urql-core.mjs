...
import { s as stringifyVariables, _ as _extends, C as CombinedError, m as makeResult, a as makeErrorResult, b as makeFetchBody, c as makeFetchURL, d as makeFetchOptions, e as makeFetchSource } from "./10c87a5f.mjs";

export { C as CombinedError, a as makeErrorResult, m as makeResult, s as stringifyVariables } from "./10c87a5f.mjs";
...
function J(a) {
  ...
  var k = a.forward, l = a.client, g = a.dispatchDebug, h = new Map;
  a = Object.create(null);
  var m = function L(a, b, c, d) {
    function e(b) {
      if (a.has(b)) {
    ...
    return a.reduceRight((function(a, b) {
      return b({
        ...
        dispatchDebug: function(a) {
          "production" !== process.env.NODE_ENV && d(_extends({}, a, {
            timestamp: Date.now(),
            source: b.name
          }));
        }
...
function Z(a) {
  ...
  if ("production" !== process.env.NODE_ENV) {
    var e = (d = makeSubject()).next, f = d.source;
